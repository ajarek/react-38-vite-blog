    ...
    <div className={'profile'}>
      ...
      <div className={'posts-id'}>
        ...
        <div className={'row-button'}>
          <button onClick={() => setParameters('dateAscending')}>
            Date Ascending
          </button>
          <button onClick={() => setParameters('dateDescending')}>
            Date Descending
          </button>
          <button onClick={() => setParameters('likesAscending')}>
            Likes Ascending
          </button>
          <button onClick={() => setParameters('likesDescending')}>
            Likes Descending
          </button>
        </div>
        {sortPosts().map((el) => {
